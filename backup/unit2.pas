...
begin
  ...
  if FCurrentDragObject <> nil then begin   //Check if Object is not empty
    ...
    FCurrentDragObject.Left := FStartDragPos.X + DeltaPos.X - Form2.ClientOrigin.X - Round(FCurrentDragObject.Width / 2);
    FCurrentDragObject.Top := FStartDragpos.Y + DeltaPos.y - Form2.ClientOrigin.Y - Round(FCurrentDragObject.Height / 2);
